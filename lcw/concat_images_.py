...
image_name = 'lcw_f5'
source_image_dir = './sample_masks/lcw_f5/'
destination_dir = './concatinated_samples/lcw_f5/'
...
directory_list = ['./Test/LCW_cracked/Test/Images/', './Test/LCW_cracked/Test/Masks/', './predicted_masks/var_LCW_cracked/', './combined_overlays/var_LCW_cracked/']
